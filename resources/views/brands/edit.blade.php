            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{URL::to('/brands')}}">All Brand
                                </a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="brand_name" class="form-control" id="brand_name"
                                    placeholder="Brand Name" required="" value="{{old('brand_name',$brand->brand_name)}}">
                                @error('brand_name')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" name="is_mega_menu" id="is_mega_menu" required="">
                                    ...
                                    <option value="1" <?php if($brand->is_mega_menu == 1){echo "selected";} ?>>Yes</option>
                                    <option value="0" <?php if($brand->is_mega_menu == 0){echo "selected";} ?>>No</option>
                                </select>
                                @error('is_mega_menu')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input name="image" type="file" id="image" accept="image/*" class="dropify" data-height="200" data-default-file="{{ URL::to($brand->image) }}"/> 
                            @error('image')
                            <span class="alert alert-danger">{{ $message }}</span>
                            @enderror
                          </div>
